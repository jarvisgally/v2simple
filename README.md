...
<img src="images/client-server.png" height="500"/>
...
<img src="images/client-forward-server.png" height="500"/>
...
V2Simple的核心逻辑都在`main.go`中，通过三个go关键字，比较简单的就实现了支持多个连接的流量转发逻辑：
```
+ 启动TCP监听 - net.Listen
